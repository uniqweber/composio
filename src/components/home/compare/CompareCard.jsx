        ...
        <div className="border overflow-hidden p-4 lg:p-6 border-black/40 bg-light group relative ">
            ...
            <div className="relative">
                <div className="flex lg:flex-col items-center lg:items-start lg:justify-start justify-between">
                    <h4 className="font-tinos tracking-wide text-xl md:text-3xl 2xl:text-4xl text-black/80 ">{item.title}</h4>
                    <p className="text-xs text-right lg:text-left md:text-base 2xl:text-lg text-black/50 font-roobert font-light">{item.subtitle}</p>
                </div>
                <div className="mt-10 lg:mt-0 flex lg:flex-col lg:items-start items-end lg:justify-start justify-between">
                    ...
                    <div className="bg-white/30 hidden lg:block font-roobert-mono tracking-wider border border-black/10 text-xs 2xl:text-sm uppercase w-max px-5 py-2 rounded-md mt-3">
                        {item.additionalCalls}
                    </div>

                    <div className="flex items-end lg:w-full font-roobert lg:justify-between  lg:mt-40 2xl:mt-48 text-black/80 lg:group-hover:text-white transition-all duration-500">
                        <span className="text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl">{item.price}</span>
